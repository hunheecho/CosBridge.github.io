# 실력별 전투 봇 × 신규 관문 보스 6종 비교(BOT_COMPARE_BOSS3)

> **주의(검수 2, 2026-09-07):** 이 표는 observe-2·skillbot-0.1 시점(검수 2 수정 전)의 결과다. 장판 인식 상속·투사체 id 변경 결함이 포함되어 있어 새 코드의 결과로 재사용하지 않는다. 수정 전후 비교(대표 보스 포함)는 `BOT_COMPARE_AUDIT2.md`.
