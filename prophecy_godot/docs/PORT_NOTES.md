...
| 12 | 후반에 한 마리씩 나옴 | 혼합 분대 등장(역할 섞기·묶음 첫 자리 근접·묶음당 지원 비율 상한·말미 묶음 확대). 후반 1~2마리 시간 92.0초 → 35.6초(변형 비교) | 구현·자동 확인 |
...
| 원인 분리 비교 | `docs/sim/BALANCE_COMPARE.md` — off/counts/hp/full × balanced·regular·skilled × 정상/3일 중단 |
