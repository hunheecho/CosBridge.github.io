...
const ORDER = ['core', 'input', 'data', 'growth_data', 'growth', 'mission_data', 'boss_data', 'balance_data', 'world_data', 'glossary_data', 'build', 'combat', 'weapons', 'skills', 'boss', 'boss2', 'enemies', 'objectives', 'run', 'sortie', 'events', 'flow', 'stats', 'glossary', 'bot', 'lab_data', 'lab'];
function load() {
