...
PA.Lab = (function () {
  ...
  function makeCombat(cfg, run) {
    ...
    if (ep.boss) { const st = PA.Combat.create(Object.assign(common, { boss: true, waves: [], bossId: ep.bossId || 'boss', bossHp: cfg.bossHp || null, run })); if (ep.dummy) { st.boss.dummy = true; st.intro = 0; } return st; }
