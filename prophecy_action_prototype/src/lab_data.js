...
PA.LAB = {
  ...
  BUILDS: {
    ...
    start_sword:  { name: '시작: 검격(Lv1, 개조·장비 없음)', stage: '시작 비교', purpose: '새 회차 첫 전투 상태 그대로. 시작 자동기술 3종 비교(같은 시드·정책)', growth: { weapons: [{ id: 'sword', level: 1 }] }, gear: {} },
    start_spear:  { name: '시작: 관통창(Lv1)', stage: '시작 비교', purpose: '시작 자동기술 3종 비교', growth: { weapons: [{ id: 'spear', level: 1 }] }, gear: {} },
    start_blades: { name: '시작: 회전 칼날(Lv1)', stage: '시작 비교', purpose: '시작 자동기술 3종 비교(살 판정, 개조 없이 공격 성립)', growth: { weapons: [{ id: 'blades', level: 1 }] }, gear: {} },
    inv_direct: { name: '같은 투자(7선택): 직접 피해 중심', stage: '투자 비교', purpose: '검 Lv4 + 교차 + 숙련 2 + 가속 1. 직접 피해에 7선택', growth: { weapons: [{ id: 'sword', level: 4, mods: ['cross'] }], passives: { mastery: 2, haste: 1 } }, gear: {} },
    inv_dot:    { name: '같은 투자(7선택): 지속 피해·장판 중심', stage: '투자 비교', purpose: '검 Lv1 + 불씨 정령 Lv3(화염 띠·재점화) + 불붙은 공격 + 지속력 1. 지속·장판에 7선택', growth: { weapons: [{ id: 'sword', level: 1 }, { id: 'ember', level: 3, mods: ['trail', 'reignite'] }], commons: { burn: 1 }, passives: { persistence: 1 } }, gear: {} },
    inv_def:    { name: '같은 투자(7선택): 방어·회복 중심', stage: '투자 비교', purpose: '검 Lv2 + 수호 결계 Lv2 + 건강 2 + 강인함 2. 방어에 7선택', growth: { weapons: [{ id: 'sword', level: 2 }], passives: { vitality: 2, toughness: 2 }, e: { id: 'ward', level: 2 } }, gear: {} },
    ...
    stage1: { name: '1단계 관문 빌드(3일차, Lv7 · 점진 전략 덤프 시드 1)', stage: '관문 1', purpose: 'v0.8 run_sim(점진·test03·시드 1)에서 3일차 관문 입장 시점 그대로: 검 2(교차) + 불씨 1 + 회전 칼날 1(사출·세 번째 칼날), E 돌풍, 원정대의 갑옷, 강화 1, 금화 122', growth: { weapons: [{ id: 'sword', level: 2, mods: ['cross'] }, { id: 'ember', level: 1 }, { id: 'blades', level: 1, mods: ['launch', 'dual'] }], e: { id: 'gust', level: 1 } }, gear: {}, equipment: { armor: 'expedition_armor' }, forge: 1, gold: 122 },
    stage2: { name: '2단계 관문 빌드(5일차, Lv12 · 덤프 시드 1)', stage: '관문 2', purpose: '5일차 봉인 수호자 입장 시점: 검 2(교차·잔류) + 불씨 1(산개·화염 띠) + 칼날 1(사출·세 번째), 냉기, E 돌풍(바람길), 희귀 일제 공격, 개척자의 창·원정대의 갑옷·시간의 방패, 강화 2, 금화 59', growth: { weapons: [{ id: 'sword', level: 2, mods: ['cross', 'scar'] }, { id: 'ember', level: 1, mods: ['scatter', 'trail'] }, { id: 'blades', level: 1, mods: ['launch', 'dual'] }], commons: { frost: 1 }, e: { id: 'gust', level: 1, variant: 'windpath' }, bossRewards: ['volley'] }, gear: {}, equipment: { weapon: 'pioneer_spear', armor: 'expedition_armor', shield: 'time_shield' }, forge: 2, gold: 59 },
    stage3: { name: '3단계 관문 빌드(7일차, Lv18 · 덤프 시드 1)', stage: '관문 3', purpose: '7일차 예언을 먹는 자 입장 시점: 검 3(교차·잔류) + 불씨 2(산개·화염 띠) + 칼날 2(사출·세 번째), 냉기·화상·불꽃 파열, Q 잔향, E 돌풍(바람길), 희귀 일제 공격·시간의 복제, 사냥꾼의 검·원정대의 갑옷·시전자의 방패, 강화 3, 금화 79', growth: { weapons: [{ id: 'sword', level: 3, mods: ['cross', 'scar'] }, { id: 'ember', level: 2, mods: ['scatter', 'trail'] }, { id: 'blades', level: 2, mods: ['launch', 'dual'] }], commons: { frost: 1, burn: 1, flare: 1 }, q: { level: 1, variant: 'echo' }, e: { id: 'gust', level: 1, variant: 'windpath' }, bossRewards: ['volley', 'clone'] }, gear: {}, equipment: { weapon: 'hunter_sword', armor: 'expedition_armor', shield: 'caster_shield' }, forge: 3, gold: 79 },
    stop3_final: { name: '3일차 성장 중단 최종 보스 빌드(Lv10 · 덤프 시드 1)', stage: '관문 3', purpose: '같은 시드·정책으로 3일차까지만 성장하고 4일차부터 휴식만 한 빌드로 7일차 최종 보스 입장: 검 2(교차·잔류) + 불씨 1(산개) + 칼날 1(사출·세 번째), 냉기, E 돌풍, 희귀 일제 공격·복제, 원정대의 갑옷, 강화 1, 금화 364(쓰지 않음)', growth: { weapons: [{ id: 'sword', level: 2, mods: ['cross', 'scar'] }, { id: 'ember', level: 1, mods: ['scatter'] }, { id: 'blades', level: 1, mods: ['launch', 'dual'] }], commons: { frost: 1 }, e: { id: 'gust', level: 1 }, bossRewards: ['volley', 'clone'] }, gear: {}, equipment: { armor: 'expedition_armor' }, forge: 1, gold: 364 },
    late_hammer:  { name: '후반 망치·지뢰 조합', stage: '후반', purpose: '전투망치 4(충격파·여진) + 룬 지뢰 3(연결·서리 함정) + 불씨 2 + 넓어진 공격 2 + 강인함·건강. 느리고 큰 한 방 계열의 상한선', growth: { weapons: [{ id: 'hammer', level: 4, mods: ['shockwave', 'aftershock'] }, { id: 'mine', level: 3, mods: ['chain', 'frosttrap'] }, { id: 'ember', level: 2 }], commons: { wide: 2, flare: 1, burn: 1 }, passives: { toughness: 2, vitality: 2, mastery: 1 }, e: { id: 'gravity', level: 2, variant: 'collapse' } }, gear: { upgrade: 2 } },
  },
