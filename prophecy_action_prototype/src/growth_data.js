...
PA.WEAPONS = {
  ...
  blades:  { name: '회전 칼날', kind: 'orbit', startable: true, impl: true, base: { damage: 8, interval: 0.45, count: 2, radius: 78, angular: 3.2, hitGap: 0.45, knock: 20 }, reach: false, width: true, category: 'direct', tags: ['melee', 'combo'],
    desc: '플레이어 주변을 도는 칼날. 궤도에 적을 걸치게 이동. 같은 적은 0.45초마다 한 번.',
    mods: { dual: { name: '이중 궤도', desc: '안쪽·바깥쪽 궤도에 칼날 배치', impl: true, tags: ['melee'] }, launch: { name: '사출 칼날', desc: '3초마다 칼날 하나가 적에게 날아갔다 복귀(피해 120%)', impl: true, tags: ['projectile'] }, serrated: { name: '톱날', desc: '적중한 적에게 짧은 출혈', impl: true, tags: ['bleed'] } } },
