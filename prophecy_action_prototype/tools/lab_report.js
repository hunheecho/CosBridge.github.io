...
if (suite === 'D' || suite === 'D2' || suite === 'D3' || suite === 'E' || suite === 'E2') {
  const VN = { 'cmp_blades@base': '칼날 기준', 'cmp_blades@dmg10': '칼날 피해 10', 'cmp_blades@gap0.35': '칼날 주기 0.35', 'cmp_blades@r90': '칼날 반지름 90', 'cmp_blades@dmg10+gap0.35': '칼날 피해10+주기0.35', cmp_sword: '검', cmp_blades: '회전 칼날', cmp_spear: '창 ×1.0', 'cmp_spear@0.85': '창 ×0.85', 'cmp_spear@0.75': '창 ×0.75', 'cmp_spear@sweet': '창 근접 약화(45% 안쪽 ×0.5)', 'cmp_spear@narrow': '창 폭 28', 'cmp_spear@pierce2': '창 관통 2명', 'cmp_spear@sweet+narrow': '창 근접 약화+폭 28', 'cmp_spear@int0.85': '창 주기 0.85', 'cmp_spear@dmg12': '창 피해 12', 'cmp_spear@sweet+int0.85': '창 근접 약화+주기 0.85', 'cmp_spear@sweet+dmg12': '창 근접 약화+피해 12' };
  const vn = (r) => VN[r.variant] || r.variant, order = ['cmp_sword', 'cmp_blades', 'cmp_blades@base', 'cmp_blades@dmg10', 'cmp_blades@gap0.35', 'cmp_blades@r90', 'cmp_blades@dmg10+gap0.35', 'cmp_spear', 'cmp_spear@0.85', 'cmp_spear@0.75', 'cmp_spear@sweet', 'cmp_spear@narrow', 'cmp_spear@pierce2', 'cmp_spear@sweet+narrow', 'cmp_spear@int0.85', 'cmp_spear@dmg12', 'cmp_spear@sweet+int0.85', 'cmp_spear@sweet+dmg12'];
