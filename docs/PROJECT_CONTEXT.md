...
| Godot 버전 | godot-0.6.0. 최종 커밋·검증·시뮬 결과는 `prophecy_godot/docs/PORT_NOTES.md` §18(0.5.0 배포물 해시는 §16). 배포물 ZIP `prophecy_godot_build/`(0.5.0 Windows 빌드 + 프로젝트 ZIP; 0.4.0·0.3.0 ZIP은 비교용으로 유지) |
